const slides = {
    lokVeda: {
        ...
        cap: [
            ...
            'Service Status',
            'Staff Dashboard',
            'Staff - Reviewing Pending Applications',
            'Viewing Submitted Application',
            'Staff - Pending Job Applications',
            "Staff - Viewing Applicant's Profile",
            "Staff - Accept Applicant's Profile",
            'Staff - Viewing Job Applications',
            'Staff - After Accepting Job Application',
            'Admin - Deactivating a Service',
            'Admin - After Deactivating a Service',
            'Admin Dashboard',
            'Admin - Approving Reviewed Applications',
            "Admin - Rejecting Applicant's Profile",
            'Citizen - Viewing Rejected Application',
            'Admin - Viewing Rejected Applications',
            "Admin - Approving Applicant's Profile",
            'Admin - Approving Rejected Application',
            'Admin - Viewing Approved Applications',
            "Admin - Viewing Approved Applicant's Profile",
            'Admin - Viewing Approved Application',
            'Citizen - Submitting a New Application',
            'Citizen - Viewing Their Profile',
            'Citizen - Viewing Their Application Status',
            'Citizen - Viewing Pending Application',
            'User Logging Out',
            'Staff Outside Allowed Distance',
            'Citizens are notified for misinformation in their application',
            'Citizen - Submitting an Application Successfully',
            'Staff - Logging In',
            'Admin - Approving an application',
            'Home Page - Logged In State'
        ],
        srs: 'lokveda/main/documentation/SRS'
    },
    soundScript: {
        idx: 0,
...
createCard(
    webCards, 'lokVeda',
    'lokveda-1.png', 'LokVeda',
    'Full-stack web app to digitalize village level services', true,
    'https://youtu.be/TLsEDz0YfLY',
    'https://github.com/dipsana/lokveda.git'
);
...
createCard(
    ...
    'A Netflix inspired landing page', true,
